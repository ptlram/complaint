...
const Complaint = () => {
  ...
  const loginhandle = async (e) => {
    ...
    // const storedFormData = JSON.parse(localStorage.getItem("complaint")) || [];

    // storedFormData.push(data);

    // localStorage.setItem("complaint", JSON.stringify(storedFormData));
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div className="com">
          ...
          />
          <input className="bt" type="submit" onClick={loginhandle} />
        </div>
      </form>
      <div>
        <Footer />
